...
```{r plots1, fig.width=8, fig.height=6, out.width='80%'}
...
```{r plots2, fig.width=8, fig.height=6, out.width='80%'}
...
``` {r plots3, fig.width=8, fig.height=6, out.width='80%'}
...
```{r plots4, fig.width=8, fig.height=6, out.width='80%'}
...
```{r plots5, fig.width=8, fig.height=6, out.width='80%'}
